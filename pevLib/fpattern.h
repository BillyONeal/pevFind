...
#ifndef NO_H_IDENT
static const TCHAR    fpattern_h_id[] =
    "@(#)lib/fpattern.h 1.03";
#endif
...
//#define FPAT_QUOTE    '\\'        /* Quotes a special TCHAR    */
#define FPAT_QUOTE2    L'`'        /* Quotes a special TCHAR    */
#define FPAT_DEL    L'/'        /* Path delimiter        */
#define FPAT_DEL2    L'\\'        /* Path delimiter        */
#define FPAT_DOT    L'.'        /* Dot TCHAR            */
#define FPAT_NOT    L'!'        /* Exclusion            */
#define FPAT_ANY    L'?'        /* Any one TCHAR            */
#define FPAT_CLOS    L'*'        /* Zero or more chars        */
#define FPAT_CLOSP    L'\x1A'        /* Zero or more nondelimiters    */
#define FPAT_SET_L    L'['        /* Set/range open bracket    */
#define FPAT_SET_R    L']'        /* Set/range close bracket    */
#define FPAT_SET_NOT    L'!'        /* Set exclusion        */
#define FPAT_SET_THRU    L'-'        /* Set range of chars        */
...
extern int    fpattern_isvalid(const wchar_t *pat);
extern int    fpattern_match(const wchar_t *pat, const wchar_t *fname);
extern int    fpattern_matchn(const wchar_t *pat, const wchar_t *fname);
